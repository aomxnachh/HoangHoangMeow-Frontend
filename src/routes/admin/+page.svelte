...
<div class="p-6 space-y-6">
	...
	<div class="grid grid-cols-1 gap-6 md:grid-cols-2">
		<a href="/admin/ads" class="block rounded-2xl border border-gray-200 bg-white p-6 shadow-sm hover:shadow-md transition-shadow hover:border-purple-300">
		...
		<a href="/admin/recommendations" class="block rounded-2xl border border-gray-200 bg-white p-6 shadow-sm hover:shadow-md transition-shadow hover:border-purple-300">
			<div class="flex items-center gap-4">
