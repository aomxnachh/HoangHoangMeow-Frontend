		...
		<div class="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
			...
			<form onsubmit={(e) => { e.preventDefault(); handleAdd(); }} class="space-y-4">
				...
				<div>
					...
					<select id="type" bind:value={formData.type} required class="w-full rounded-xl border border-gray-200 px-4 py-2 outline-none focus:border-rose-400 focus:ring-2 focus:ring-rose-100">
				...
				<div>
					...
					<input type="text" id="title" bind:value={formData.title} required class="w-full rounded-xl border border-gray-200 px-4 py-2 outline-none focus:border-rose-400 focus:ring-2 focus:ring-rose-100" />
				</div>
				<div>
					<label class="block text-sm font-medium text-gray-700 mb-1" for="description">รายละเอียด</label>
					<textarea id="description" bind:value={formData.description} class="w-full rounded-xl border border-gray-200 px-4 py-2 outline-none focus:border-rose-400 focus:ring-2 focus:ring-rose-100"></textarea>
				</div>
				<div>
				...
				<div>
					...
					<input type="text" id="provider" bind:value={formData.provider} class="w-full rounded-xl border border-gray-200 px-4 py-2 outline-none focus:border-rose-400 focus:ring-2 focus:ring-rose-100" />
				</div>
				<div>
					<label class="block text-sm font-medium text-gray-700 mb-1" for="cost">ค่าใช้จ่าย (บาท)</label>
					<input type="number" id="cost" bind:value={formData.cost} min="0" required class="w-full rounded-xl border border-gray-200 px-4 py-2 outline-none focus:border-rose-400 focus:ring-2 focus:ring-rose-100" />
				</div>
